  ...
  return (
    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-2">
      {services.map((service) => {
        ...
        return (
          <Card key={service.id} className="h-full bg-stone-800/50 border-stone-700 hover:bg-stone-800/70 transition-all duration-300 group shadow-lg">
            <CardHeader className="pb-4">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-3 bg-gradient-to-br from-amber-600/20 to-orange-600/20 border border-amber-500/30" style={{ borderRadius: '0.25rem 0.75rem 0.25rem 0.75rem' }}>
                  <Icon className="w-5 h-5 text-amber-500" />
                </div>
              </div>
              <CardTitle className="text-xl text-white group-hover:text-amber-200 transition-colors font-semibold">
                {service.title}
              </CardTitle>
              <CardDescription className="text-stone-400 font-light">
                {service.description}
              </CardDescription>
            </CardHeader>
                ...
                {service.id === 'ai-architecture' && (
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <div className="w-1.5 h-1.5 bg-amber-500" style={{ borderRadius: '0.125rem 0.375rem 0.125rem 0.375rem' }} />
